...
// Tell Room's KSP processor where to write the per-version schema
// snapshots. They get committed to git so we can author proper
// Migration classes against past versions instead of relying on
